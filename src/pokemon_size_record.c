...
void GetHeracrossSizeRecordInfo(void)
{
    ...
    GetMonSizeRecordInfo(SPECIES_SPIRA, sizeRecord);
}
...
void CompareHeracrossSize(void)
{
    ...
    gSpecialVar_Result = CompareMonSize(SPECIES_AEROPE, sizeRecord);
}
...
void GetMagikarpSizeRecordInfo(void)
{
    ...
    GetMonSizeRecordInfo(SPECIES_FUMIX, sizeRecord);
}
...
void CompareMagikarpSize(void)
{
    ...
    gSpecialVar_Result = CompareMonSize(SPECIES_SCROLLUX, sizeRecord);
}
