...
{
    SPECIES_TO_HOENN(PETALIX),
    SPECIES_TO_HOENN(PETALUX),
    SPECIES_TO_HOENN(PETALIA),
    SPECIES_TO_HOENN(SCORCH),
    SPECIES_TO_HOENN(SCORION),
    SPECIES_TO_HOENN(SCROBA),
    SPECIES_TO_HOENN(VICTIRAH),
    SPECIES_TO_HOENN(VITARI),
    SPECIES_TO_HOENN(VITALUXE),
    SPECIES_TO_HOENN(AETHERON),
    SPECIES_TO_HOENN(AETHRI),
    SPECIES_TO_HOENN(VERDIGO),
    SPECIES_TO_HOENN(VERALIS),
    SPECIES_TO_HOENN(VERMEA),
    SPECIES_TO_HOENN(TORVIA),
    SPECIES_TO_HOENN(CELIGRA),
    SPECIES_TO_HOENN(CELUMI),
    SPECIES_TO_HOENN(FLENURA),
    SPECIES_TO_HOENN(FLENIXA),
    SPECIES_TO_HOENN(FLORENA),
    SPECIES_TO_HOENN(PULSX),
    SPECIES_TO_HOENN(PULSAR),
    SPECIES_TO_HOENN(PULSITE),
    SPECIES_TO_HOENN(TENEBRA),
    SPECIES_TO_HOENN(CRAGS),
    SPECIES_TO_HOENN(CRAGNOS),
    SPECIES_TO_HOENN(MIRAK),
    SPECIES_TO_HOENN(MIXER),
    SPECIES_TO_HOENN(KRYPTA),
    SPECIES_TO_HOENN(CRYPTIN),
    SPECIES_TO_HOENN(CRYPTOR),
    SPECIES_TO_HOENN(KHILRIN),
    SPECIES_TO_HOENN(ASTEROS),
    SPECIES_TO_HOENN(GYROP),
    SPECIES_TO_HOENN(CALLIGO),
    SPECIES_TO_HOENN(ASTRUX),
    SPECIES_TO_HOENN(VIRIDIA),
    SPECIES_TO_HOENN(VIRELIA),
    SPECIES_TO_HOENN(VEIRAN),
    SPECIES_TO_HOENN(FURIX),
    SPECIES_TO_HOENN(STELLAL),
    SPECIES_TO_HOENN(URAGI),
    SPECIES_TO_HOENN(URAGON),
    SPECIES_TO_HOENN(UROBOR),
    SPECIES_TO_HOENN(TERRAGUL),
    SPECIES_TO_HOENN(TERRACAEL),
    SPECIES_TO_HOENN(SPIRA),
    SPECIES_TO_HOENN(FUMIX),
    SPECIES_TO_HOENN(FUMARA),
    SPECIES_TO_HOENN(FUMARIN),
    SPECIES_TO_HOENN(TENEBROUS),
    SPECIES_TO_HOENN(TENEKROF),
    SPECIES_TO_HOENN(LEMTUR),
    SPECIES_TO_HOENN(VINEIA),
    SPECIES_TO_HOENN(VINEKOR),
    SPECIES_TO_HOENN(VINTRUB),
    SPECIES_TO_HOENN(MOMOZA),
    SPECIES_TO_HOENN(MOMOZOA),
    SPECIES_TO_HOENN(MOMORAI),
    SPECIES_TO_HOENN(NURVIO),
    SPECIES_TO_HOENN(NURVIS),
    SPECIES_TO_HOENN(NURIMAR),
    SPECIES_TO_HOENN(KLOUDA),
    SPECIES_TO_HOENN(KLODION),
    SPECIES_TO_HOENN(TERRAZO),
    SPECIES_TO_HOENN(TERRIGRON),
    SPECIES_TO_HOENN(TERRAGO),
    SPECIES_TO_HOENN(DOXON),
    SPECIES_TO_HOENN(DOXYON),
    SPECIES_TO_HOENN(AURARA),
    SPECIES_TO_HOENN(AURORA),
    SPECIES_TO_HOENN(SORVUS),
    SPECIES_TO_HOENN(SORVOL),
    SPECIES_TO_HOENN(TECHI),
    SPECIES_TO_HOENN(TECHSOL),
    SPECIES_TO_HOENN(TECHURA),
    SPECIES_TO_HOENN(BRONZIX),
    SPECIES_TO_HOENN(DUNRAH),
    SPECIES_TO_HOENN(DUNARE),
    SPECIES_TO_HOENN(CRYSTA),
    SPECIES_TO_HOENN(KORVISA),
    SPECIES_TO_HOENN(KORVIX),
    SPECIES_TO_HOENN(KORVAX),
    SPECIES_TO_HOENN(SEALORA),
    SPECIES_TO_HOENN(SEALEIRA),
    SPECIES_TO_HOENN(KAIDIKO),
    SPECIES_TO_HOENN(PUPATOR),
    SPECIES_TO_HOENN(AKMIDA),
    SPECIES_TO_HOENN(RIVAGER),
    SPECIES_TO_HOENN(RIVILE),
    SPECIES_TO_HOENN(KARASHY),
    SPECIES_TO_HOENN(AGATORA),
    SPECIES_TO_HOENN(AGARIKS),
    SPECIES_TO_HOENN(AGRAKA),
    SPECIES_TO_HOENN(POCHET),
    SPECIES_TO_HOENN(POCHETLIN),
    SPECIES_TO_HOENN(POJEKT),
    SPECIES_TO_HOENN(SERENITE),
    SPECIES_TO_HOENN(SERINAX),
    SPECIES_TO_HOENN(LUMINE),
    SPECIES_TO_HOENN(LUMINON),
    SPECIES_TO_HOENN(CELESTIS),
    SPECIES_TO_HOENN(CELESTUS),
    SPECIES_TO_HOENN(STELARUS),
    SPECIES_TO_HOENN(CROQUON),
    SPECIES_TO_HOENN(FANGOR),
    SPECIES_TO_HOENN(VERDURA),
    SPECIES_TO_HOENN(VERDUUS),
    SPECIES_TO_HOENN(ASTARVE),
    SPECIES_TO_HOENN(TUNDRAX),
    SPECIES_TO_HOENN(TARNEX),
    SPECIES_TO_HOENN(SCROLIA),
    SPECIES_TO_HOENN(SCROLLUX),
    SPECIES_TO_HOENN(AERHONE),
    SPECIES_TO_HOENN(AEROLUT),
    SPECIES_TO_HOENN(AERODIX),
    SPECIES_TO_HOENN(AERTHYS),
    SPECIES_TO_HOENN(ARTHYS),
    SPECIES_TO_HOENN(CALLISTA),
    SPECIES_TO_HOENN(LURAS),
    SPECIES_TO_HOENN(LURIOS),
    SPECIES_TO_HOENN(LURION),
    SPECIES_TO_HOENN(IGNITOR),
    SPECIES_TO_HOENN(AQUAVOLE),
    SPECIES_TO_HOENN(AKVORA),
    SPECIES_TO_HOENN(RHINOKS),
    SPECIES_TO_HOENN(ROKITU),
    SPECIES_TO_HOENN(SORILI),
    SPECIES_TO_HOENN(SERILI),
    SPECIES_TO_HOENN(FUMIGA),
    SPECIES_TO_HOENN(FUMINIA),
    SPECIES_TO_HOENN(FUMINDO),
    SPECIES_TO_HOENN(TERRAKO),
    SPECIES_TO_HOENN(TERROBE),
    SPECIES_TO_HOENN(TERRIGON),
    SPECIES_TO_HOENN(AEROPE),
    SPECIES_TO_HOENN(AEROPEX),
    SPECIES_TO_HOENN(VESPAS),
    SPECIES_TO_HOENN(VESPERA),
    SPECIES_TO_HOENN(GRAPHSIM),
    SPECIES_TO_HOENN(EMBRIS),
    SPECIES_TO_HOENN(EMBERG),
    SPECIES_TO_HOENN(EMBLAZE),
    SPECIES_TO_HOENN(LEVORA),
    SPECIES_TO_HOENN(LEVAXON),
    SPECIES_TO_HOENN(LEVIORA),
    SPECIES_TO_HOENN(ROKUIL),
    SPECIES_TO_HOENN(CRYSTALUX),
    SPECIES_TO_HOENN(CRYSTAZE),
    SPECIES_TO_HOENN(TINSTRY),
    SPECIES_TO_HOENN(LIGNANT),
    SPECIES_TO_HOENN(LUMINANT),
    SPECIES_TO_HOENN(LUMINUXE),
    SPECIES_TO_HOENN(GLIMMOR),
    SPECIES_TO_HOENN(CALCIMONK),
    SPECIES_TO_HOENN(CALCLION),
    SPECIES_TO_HOENN(RUSTHOR),
    SPECIES_TO_HOENN(ALKON),
    SPECIES_TO_HOENN(TINTINN),
    SPECIES_TO_HOENN(TINNION),
    SPECIES_TO_HOENN(TINNEK),
    SPECIES_TO_HOENN(LUMIN),
    SPECIES_TO_HOENN(LUMINOR),
    SPECIES_TO_HOENN(PRANJORA),
    SPECIES_TO_HOENN(CHRONIS),
    SPECIES_TO_HOENN(IGNIFERT),
    SPECIES_TO_HOENN(IGNINTO),
    SPECIES_TO_HOENN(TERRO),
    SPECIES_TO_HOENN(ROCKPIN),
    SPECIES_TO_HOENN(QILINI),
    SPECIES_TO_HOENN(GELRATH),
    SPECIES_TO_HOENN(GELRAID),
    SPECIES_TO_HOENN(GLIMPIN),
    SPECIES_TO_HOENN(GLIMVIR),
    SPECIES_TO_HOENN(GLIMION),
    SPECIES_TO_HOENN(AURSURF),
    SPECIES_TO_HOENN(AURIVORE),
    SPECIES_TO_HOENN(ONYRIX),
    SPECIES_TO_HOENN(ONYXYS),
    SPECIES_TO_HOENN(KAELOS),
    SPECIES_TO_HOENN(CUIMOS),
    SPECIES_TO_HOENN(KOROBI),
    SPECIES_TO_HOENN(CULMOTH),
    SPECIES_TO_HOENN(BOUNDI),
    SPECIES_TO_HOENN(BOUNDIERE),
    SPECIES_TO_HOENN(GRUMM),
    SPECIES_TO_HOENN(GLITAS),
    SPECIES_TO_HOENN(GLITRON),
    SPECIES_TO_HOENN(MISTILE),
    SPECIES_TO_HOENN(YUREKI),
    SPECIES_TO_HOENN(YUKIMI),
    SPECIES_TO_HOENN(YUMIRA),
    SPECIES_TO_HOENN(TURBIN),
    SPECIES_TO_HOENN(TURMADE),
    SPECIES_TO_HOENN(TURMAG),
    SPECIES_TO_HOENN(ELECTORO),
    SPECIES_TO_HOENN(ELECTRON),
    SPECIES_TO_HOENN(EXCAVA),
    SPECIES_TO_HOENN(EXCELSIA),
    SPECIES_TO_HOENN(DUSTOS),
    SPECIES_TO_HOENN(DUSTOR),
    SPECIES_TO_HOENN(AERFER),
    SPECIES_TO_HOENN(AERAXIS),
    SPECIES_TO_HOENN(FLARION),
    SPECIES_TO_HOENN(FLARIX),
...
{
    SPECIES_TO_NATIONAL(PETALIX),
    SPECIES_TO_NATIONAL(PETALUX),
    SPECIES_TO_NATIONAL(PETALIA),
    SPECIES_TO_NATIONAL(SCORCH),
    SPECIES_TO_NATIONAL(SCORION),
    SPECIES_TO_NATIONAL(SCROBA),
    SPECIES_TO_NATIONAL(VICTIRAH),
    SPECIES_TO_NATIONAL(VITARI),
    SPECIES_TO_NATIONAL(VITALUXE),
    SPECIES_TO_NATIONAL(AETHERON),
    SPECIES_TO_NATIONAL(AETHRI),
    SPECIES_TO_NATIONAL(VERDIGO),
    SPECIES_TO_NATIONAL(VERALIS),
    SPECIES_TO_NATIONAL(VERMEA),
    SPECIES_TO_NATIONAL(TORVIA),
    SPECIES_TO_NATIONAL(CELIGRA),
    SPECIES_TO_NATIONAL(CELUMI),
    SPECIES_TO_NATIONAL(FLENURA),
    SPECIES_TO_NATIONAL(FLENIXA),
    SPECIES_TO_NATIONAL(FLORENA),
    SPECIES_TO_NATIONAL(PULSX),
    SPECIES_TO_NATIONAL(PULSAR),
    SPECIES_TO_NATIONAL(PULSITE),
    SPECIES_TO_NATIONAL(TENEBRA),
    SPECIES_TO_NATIONAL(CRAGS),
    SPECIES_TO_NATIONAL(CRAGNOS),
    SPECIES_TO_NATIONAL(MIRAK),
    SPECIES_TO_NATIONAL(MIXER),
    SPECIES_TO_NATIONAL(KRYPTA),
    SPECIES_TO_NATIONAL(CRYPTIN),
    SPECIES_TO_NATIONAL(CRYPTOR),
    SPECIES_TO_NATIONAL(KHILRIN),
    SPECIES_TO_NATIONAL(ASTEROS),
    SPECIES_TO_NATIONAL(GYROP),
    SPECIES_TO_NATIONAL(CALLIGO),
    SPECIES_TO_NATIONAL(ASTRUX),
    SPECIES_TO_NATIONAL(VIRIDIA),
    SPECIES_TO_NATIONAL(VIRELIA),
    SPECIES_TO_NATIONAL(VEIRAN),
    SPECIES_TO_NATIONAL(FURIX),
    SPECIES_TO_NATIONAL(STELLAL),
    SPECIES_TO_NATIONAL(URAGI),
    SPECIES_TO_NATIONAL(URAGON),
    SPECIES_TO_NATIONAL(UROBOR),
    SPECIES_TO_NATIONAL(TERRAGUL),
    SPECIES_TO_NATIONAL(TERRACAEL),
    SPECIES_TO_NATIONAL(SPIRA),
    SPECIES_TO_NATIONAL(FUMIX),
    SPECIES_TO_NATIONAL(FUMARA),
    SPECIES_TO_NATIONAL(FUMARIN),
    SPECIES_TO_NATIONAL(TENEBROUS),
    SPECIES_TO_NATIONAL(TENEKROF),
    SPECIES_TO_NATIONAL(LEMTUR),
    SPECIES_TO_NATIONAL(VINEIA),
    SPECIES_TO_NATIONAL(VINEKOR),
    SPECIES_TO_NATIONAL(VINTRUB),
    SPECIES_TO_NATIONAL(MOMOZA),
    SPECIES_TO_NATIONAL(MOMOZOA),
    SPECIES_TO_NATIONAL(MOMORAI),
    SPECIES_TO_NATIONAL(NURVIO),
    SPECIES_TO_NATIONAL(NURVIS),
    SPECIES_TO_NATIONAL(NURIMAR),
    SPECIES_TO_NATIONAL(KLOUDA),
    SPECIES_TO_NATIONAL(KLODION),
    SPECIES_TO_NATIONAL(TERRAZO),
    SPECIES_TO_NATIONAL(TERRIGRON),
    SPECIES_TO_NATIONAL(TERRAGO),
    SPECIES_TO_NATIONAL(DOXON),
    SPECIES_TO_NATIONAL(DOXYON),
    SPECIES_TO_NATIONAL(AURARA),
    SPECIES_TO_NATIONAL(AURORA),
    SPECIES_TO_NATIONAL(SORVUS),
    SPECIES_TO_NATIONAL(SORVOL),
    SPECIES_TO_NATIONAL(TECHI),
    SPECIES_TO_NATIONAL(TECHSOL),
    SPECIES_TO_NATIONAL(TECHURA),
    SPECIES_TO_NATIONAL(BRONZIX),
    SPECIES_TO_NATIONAL(DUNRAH),
    SPECIES_TO_NATIONAL(DUNARE),
    SPECIES_TO_NATIONAL(CRYSTA),
    SPECIES_TO_NATIONAL(KORVISA),
    SPECIES_TO_NATIONAL(KORVIX),
    SPECIES_TO_NATIONAL(KORVAX),
    SPECIES_TO_NATIONAL(SEALORA),
    SPECIES_TO_NATIONAL(SEALEIRA),
    SPECIES_TO_NATIONAL(KAIDIKO),
    SPECIES_TO_NATIONAL(PUPATOR),
    SPECIES_TO_NATIONAL(AKMIDA),
    SPECIES_TO_NATIONAL(RIVAGER),
    SPECIES_TO_NATIONAL(RIVILE),
    SPECIES_TO_NATIONAL(KARASHY),
    SPECIES_TO_NATIONAL(AGATORA),
    SPECIES_TO_NATIONAL(AGARIKS),
    SPECIES_TO_NATIONAL(AGRAKA),
    SPECIES_TO_NATIONAL(POCHET),
    SPECIES_TO_NATIONAL(POCHETLIN),
    SPECIES_TO_NATIONAL(POJEKT),
    SPECIES_TO_NATIONAL(SERENITE),
    SPECIES_TO_NATIONAL(SERINAX),
    SPECIES_TO_NATIONAL(LUMINE),
    SPECIES_TO_NATIONAL(LUMINON),
    SPECIES_TO_NATIONAL(CELESTIS),
    SPECIES_TO_NATIONAL(CELESTUS),
    SPECIES_TO_NATIONAL(STELARUS),
    SPECIES_TO_NATIONAL(CROQUON),
    SPECIES_TO_NATIONAL(FANGOR),
    SPECIES_TO_NATIONAL(VERDURA),
    SPECIES_TO_NATIONAL(VERDUUS),
    SPECIES_TO_NATIONAL(ASTARVE),
    SPECIES_TO_NATIONAL(TUNDRAX),
    SPECIES_TO_NATIONAL(TARNEX),
    SPECIES_TO_NATIONAL(SCROLIA),
    SPECIES_TO_NATIONAL(SCROLLUX),
    SPECIES_TO_NATIONAL(AERHONE),
    SPECIES_TO_NATIONAL(AEROLUT),
    SPECIES_TO_NATIONAL(AERODIX),
    SPECIES_TO_NATIONAL(AERTHYS),
    SPECIES_TO_NATIONAL(ARTHYS),
    SPECIES_TO_NATIONAL(CALLISTA),
    SPECIES_TO_NATIONAL(LURAS),
    SPECIES_TO_NATIONAL(LURIOS),
    SPECIES_TO_NATIONAL(LURION),
    SPECIES_TO_NATIONAL(IGNITOR),
    SPECIES_TO_NATIONAL(AQUAVOLE),
    SPECIES_TO_NATIONAL(AKVORA),
    SPECIES_TO_NATIONAL(RHINOKS),
    SPECIES_TO_NATIONAL(ROKITU),
    SPECIES_TO_NATIONAL(SORILI),
    SPECIES_TO_NATIONAL(SERILI),
    SPECIES_TO_NATIONAL(FUMIGA),
    SPECIES_TO_NATIONAL(FUMINIA),
    SPECIES_TO_NATIONAL(FUMINDO),
    SPECIES_TO_NATIONAL(TERRAKO),
    SPECIES_TO_NATIONAL(TERROBE),
    SPECIES_TO_NATIONAL(TERRIGON),
    SPECIES_TO_NATIONAL(AEROPE),
    SPECIES_TO_NATIONAL(AEROPEX),
    SPECIES_TO_NATIONAL(VESPAS),
    SPECIES_TO_NATIONAL(VESPERA),
    SPECIES_TO_NATIONAL(GRAPHSIM),
    SPECIES_TO_NATIONAL(EMBRIS),
    SPECIES_TO_NATIONAL(EMBERG),
    SPECIES_TO_NATIONAL(EMBLAZE),
    SPECIES_TO_NATIONAL(LEVORA),
    SPECIES_TO_NATIONAL(LEVAXON),
    SPECIES_TO_NATIONAL(LEVIORA),
    SPECIES_TO_NATIONAL(ROKUIL),
    SPECIES_TO_NATIONAL(CRYSTALUX),
    SPECIES_TO_NATIONAL(CRYSTAZE),
    SPECIES_TO_NATIONAL(TINSTRY),
    SPECIES_TO_NATIONAL(LIGNANT),
    SPECIES_TO_NATIONAL(LUMINANT),
    SPECIES_TO_NATIONAL(LUMINUXE),
    SPECIES_TO_NATIONAL(GLIMMOR),
    SPECIES_TO_NATIONAL(CALCIMONK),
    SPECIES_TO_NATIONAL(CALCLION),
    SPECIES_TO_NATIONAL(RUSTHOR),
    SPECIES_TO_NATIONAL(ALKON),
    SPECIES_TO_NATIONAL(TINTINN),
    SPECIES_TO_NATIONAL(TINNION),
    SPECIES_TO_NATIONAL(TINNEK),
    SPECIES_TO_NATIONAL(LUMIN),
    SPECIES_TO_NATIONAL(LUMINOR),
    SPECIES_TO_NATIONAL(PRANJORA),
    SPECIES_TO_NATIONAL(CHRONIS),
    SPECIES_TO_NATIONAL(IGNIFERT),
    SPECIES_TO_NATIONAL(IGNINTO),
    SPECIES_TO_NATIONAL(TERRO),
    SPECIES_TO_NATIONAL(ROCKPIN),
    SPECIES_TO_NATIONAL(QILINI),
    SPECIES_TO_NATIONAL(GELRATH),
    SPECIES_TO_NATIONAL(GELRAID),
    SPECIES_TO_NATIONAL(GLIMPIN),
    SPECIES_TO_NATIONAL(GLIMVIR),
    SPECIES_TO_NATIONAL(GLIMION),
    SPECIES_TO_NATIONAL(AURSURF),
    SPECIES_TO_NATIONAL(AURIVORE),
    SPECIES_TO_NATIONAL(ONYRIX),
    SPECIES_TO_NATIONAL(ONYXYS),
    SPECIES_TO_NATIONAL(KAELOS),
    SPECIES_TO_NATIONAL(CUIMOS),
    SPECIES_TO_NATIONAL(KOROBI),
    SPECIES_TO_NATIONAL(CULMOTH),
    SPECIES_TO_NATIONAL(BOUNDI),
    SPECIES_TO_NATIONAL(BOUNDIERE),
    SPECIES_TO_NATIONAL(GRUMM),
    SPECIES_TO_NATIONAL(GLITAS),
    SPECIES_TO_NATIONAL(GLITRON),
    SPECIES_TO_NATIONAL(MISTILE),
    SPECIES_TO_NATIONAL(YUREKI),
    SPECIES_TO_NATIONAL(YUKIMI),
    SPECIES_TO_NATIONAL(YUMIRA),
    SPECIES_TO_NATIONAL(TURBIN),
    SPECIES_TO_NATIONAL(TURMADE),
    SPECIES_TO_NATIONAL(TURMAG),
    SPECIES_TO_NATIONAL(ELECTORO),
    SPECIES_TO_NATIONAL(ELECTRON),
    SPECIES_TO_NATIONAL(EXCAVA),
    SPECIES_TO_NATIONAL(EXCELSIA),
    SPECIES_TO_NATIONAL(DUSTOS),
    SPECIES_TO_NATIONAL(DUSTOR),
    SPECIES_TO_NATIONAL(AERFER),
    SPECIES_TO_NATIONAL(AERAXIS),
    SPECIES_TO_NATIONAL(FLARION),
    SPECIES_TO_NATIONAL(FLARIX),
...
{
    HOENN_TO_NATIONAL(PETALIX),
    HOENN_TO_NATIONAL(PETALUX),
    HOENN_TO_NATIONAL(PETALIA),
    HOENN_TO_NATIONAL(SCORCH),
    HOENN_TO_NATIONAL(SCORION),
    HOENN_TO_NATIONAL(SCROBA),
    HOENN_TO_NATIONAL(VICTIRAH),
    HOENN_TO_NATIONAL(VITARI),
    HOENN_TO_NATIONAL(VITALUXE),
    HOENN_TO_NATIONAL(AETHERON),
    HOENN_TO_NATIONAL(AETHRI),
    HOENN_TO_NATIONAL(VERDIGO),
    HOENN_TO_NATIONAL(VERALIS),
    HOENN_TO_NATIONAL(VERMEA),
    HOENN_TO_NATIONAL(TORVIA),
    HOENN_TO_NATIONAL(CELIGRA),
    HOENN_TO_NATIONAL(CELUMI),
    HOENN_TO_NATIONAL(FLENURA),
    HOENN_TO_NATIONAL(FLENIXA),
    HOENN_TO_NATIONAL(FLORENA),
    HOENN_TO_NATIONAL(PULSX),
    HOENN_TO_NATIONAL(PULSAR),
    HOENN_TO_NATIONAL(PULSITE),
    HOENN_TO_NATIONAL(TENEBRA),
    HOENN_TO_NATIONAL(CRAGS),
    HOENN_TO_NATIONAL(CRAGNOS),
    HOENN_TO_NATIONAL(MIRAK),
    HOENN_TO_NATIONAL(MIXER),
    HOENN_TO_NATIONAL(KRYPTA),
    HOENN_TO_NATIONAL(CRYPTIN),
    HOENN_TO_NATIONAL(CRYPTOR),
    HOENN_TO_NATIONAL(KHILRIN),
    HOENN_TO_NATIONAL(ASTEROS),
    HOENN_TO_NATIONAL(GYROP),
    HOENN_TO_NATIONAL(CALLIGO),
    HOENN_TO_NATIONAL(ASTRUX),
    HOENN_TO_NATIONAL(VIRIDIA),
    HOENN_TO_NATIONAL(VIRELIA),
    HOENN_TO_NATIONAL(VEIRAN),
    HOENN_TO_NATIONAL(FURIX),
    HOENN_TO_NATIONAL(STELLAL),
    HOENN_TO_NATIONAL(URAGI),
    HOENN_TO_NATIONAL(URAGON),
    HOENN_TO_NATIONAL(UROBOR),
    HOENN_TO_NATIONAL(TERRAGUL),
    HOENN_TO_NATIONAL(TERRACAEL),
    HOENN_TO_NATIONAL(SPIRA),
    HOENN_TO_NATIONAL(FUMIX),
    HOENN_TO_NATIONAL(FUMARA),
    HOENN_TO_NATIONAL(FUMARIN),
    HOENN_TO_NATIONAL(TENEBROUS),
    HOENN_TO_NATIONAL(TENEKROF),
    HOENN_TO_NATIONAL(LEMTUR),
    HOENN_TO_NATIONAL(VINEIA),
    HOENN_TO_NATIONAL(VINEKOR),
    HOENN_TO_NATIONAL(VINTRUB),
    HOENN_TO_NATIONAL(MOMOZA),
    HOENN_TO_NATIONAL(MOMOZOA),
    HOENN_TO_NATIONAL(MOMORAI),
    HOENN_TO_NATIONAL(NURVIO),
    HOENN_TO_NATIONAL(NURVIS),
    HOENN_TO_NATIONAL(NURIMAR),
    HOENN_TO_NATIONAL(KLOUDA),
    HOENN_TO_NATIONAL(KLODION),
    HOENN_TO_NATIONAL(TERRAZO),
    HOENN_TO_NATIONAL(TERRIGRON),
    HOENN_TO_NATIONAL(TERRAGO),
    HOENN_TO_NATIONAL(DOXON),
    HOENN_TO_NATIONAL(DOXYON),
    HOENN_TO_NATIONAL(AURARA),
    HOENN_TO_NATIONAL(AURORA),
    HOENN_TO_NATIONAL(SORVUS),
    HOENN_TO_NATIONAL(SORVOL),
    HOENN_TO_NATIONAL(TECHI),
    HOENN_TO_NATIONAL(TECHSOL),
    HOENN_TO_NATIONAL(TECHURA),
    HOENN_TO_NATIONAL(BRONZIX),
    HOENN_TO_NATIONAL(DUNRAH),
    HOENN_TO_NATIONAL(DUNARE),
    HOENN_TO_NATIONAL(CRYSTA),
    HOENN_TO_NATIONAL(KORVISA),
    HOENN_TO_NATIONAL(KORVIX),
    HOENN_TO_NATIONAL(KORVAX),
    HOENN_TO_NATIONAL(SEALORA),
    HOENN_TO_NATIONAL(SEALEIRA),
    HOENN_TO_NATIONAL(KAIDIKO),
    HOENN_TO_NATIONAL(PUPATOR),
    HOENN_TO_NATIONAL(AKMIDA),
    HOENN_TO_NATIONAL(RIVAGER),
    HOENN_TO_NATIONAL(RIVILE),
    HOENN_TO_NATIONAL(KARASHY),
    HOENN_TO_NATIONAL(AGATORA),
    HOENN_TO_NATIONAL(AGARIKS),
    HOENN_TO_NATIONAL(AGRAKA),
    HOENN_TO_NATIONAL(POCHET),
    HOENN_TO_NATIONAL(POCHETLIN),
    HOENN_TO_NATIONAL(POJEKT),
    HOENN_TO_NATIONAL(SERENITE),
    HOENN_TO_NATIONAL(SERINAX),
    HOENN_TO_NATIONAL(LUMINE),
    HOENN_TO_NATIONAL(LUMINON),
    HOENN_TO_NATIONAL(CELESTIS),
    HOENN_TO_NATIONAL(CELESTUS),
    HOENN_TO_NATIONAL(STELARUS),
    HOENN_TO_NATIONAL(CROQUON),
    HOENN_TO_NATIONAL(FANGOR),
    HOENN_TO_NATIONAL(VERDURA),
    HOENN_TO_NATIONAL(VERDUUS),
    HOENN_TO_NATIONAL(ASTARVE),
    HOENN_TO_NATIONAL(TUNDRAX),
    HOENN_TO_NATIONAL(TARNEX),
    HOENN_TO_NATIONAL(SCROLIA),
    HOENN_TO_NATIONAL(SCROLLUX),
    HOENN_TO_NATIONAL(AERHONE),
    HOENN_TO_NATIONAL(AEROLUT),
    HOENN_TO_NATIONAL(AERODIX),
    HOENN_TO_NATIONAL(AERTHYS),
    HOENN_TO_NATIONAL(ARTHYS),
    HOENN_TO_NATIONAL(CALLISTA),
    HOENN_TO_NATIONAL(LURAS),
    HOENN_TO_NATIONAL(LURIOS),
    HOENN_TO_NATIONAL(LURION),
    HOENN_TO_NATIONAL(IGNITOR),
    HOENN_TO_NATIONAL(AQUAVOLE),
    HOENN_TO_NATIONAL(AKVORA),
    HOENN_TO_NATIONAL(RHINOKS),
    HOENN_TO_NATIONAL(ROKITU),
    HOENN_TO_NATIONAL(SORILI),
    HOENN_TO_NATIONAL(SERILI),
    HOENN_TO_NATIONAL(FUMIGA),
    HOENN_TO_NATIONAL(FUMINIA),
    HOENN_TO_NATIONAL(FUMINDO),
    HOENN_TO_NATIONAL(TERRAKO),
    HOENN_TO_NATIONAL(TERROBE),
    HOENN_TO_NATIONAL(TERRIGON),
    HOENN_TO_NATIONAL(AEROPE),
    HOENN_TO_NATIONAL(AEROPEX),
    HOENN_TO_NATIONAL(VESPAS),
    HOENN_TO_NATIONAL(VESPERA),
    HOENN_TO_NATIONAL(GRAPHSIM),
    HOENN_TO_NATIONAL(EMBRIS),
    HOENN_TO_NATIONAL(EMBERG),
    HOENN_TO_NATIONAL(EMBLAZE),
    HOENN_TO_NATIONAL(LEVORA),
    HOENN_TO_NATIONAL(LEVAXON),
    HOENN_TO_NATIONAL(LEVIORA),
    HOENN_TO_NATIONAL(ROKUIL),
    HOENN_TO_NATIONAL(CRYSTALUX),
    HOENN_TO_NATIONAL(CRYSTAZE),
    HOENN_TO_NATIONAL(TINSTRY),
    HOENN_TO_NATIONAL(LIGNANT),
    HOENN_TO_NATIONAL(LUMINANT),
    HOENN_TO_NATIONAL(LUMINUXE),
    HOENN_TO_NATIONAL(GLIMMOR),
    HOENN_TO_NATIONAL(CALCIMONK),
    HOENN_TO_NATIONAL(CALCLION),
    HOENN_TO_NATIONAL(RUSTHOR),
    HOENN_TO_NATIONAL(ALKON),
    HOENN_TO_NATIONAL(TINTINN),
    HOENN_TO_NATIONAL(TINNION),
    HOENN_TO_NATIONAL(TINNEK),
    HOENN_TO_NATIONAL(LUMIN),
    HOENN_TO_NATIONAL(LUMINOR),
    HOENN_TO_NATIONAL(PRANJORA),
    HOENN_TO_NATIONAL(CHRONIS),
    HOENN_TO_NATIONAL(IGNIFERT),
    HOENN_TO_NATIONAL(IGNINTO),
    HOENN_TO_NATIONAL(TERRO),
    HOENN_TO_NATIONAL(ROCKPIN),
    HOENN_TO_NATIONAL(QILINI),
    HOENN_TO_NATIONAL(GELRATH),
    HOENN_TO_NATIONAL(GELRAID),
    HOENN_TO_NATIONAL(GLIMPIN),
    HOENN_TO_NATIONAL(GLIMVIR),
    HOENN_TO_NATIONAL(GLIMION),
    HOENN_TO_NATIONAL(AURSURF),
    HOENN_TO_NATIONAL(AURIVORE),
    HOENN_TO_NATIONAL(ONYRIX),
    HOENN_TO_NATIONAL(ONYXYS),
    HOENN_TO_NATIONAL(KAELOS),
    HOENN_TO_NATIONAL(CUIMOS),
    HOENN_TO_NATIONAL(KOROBI),
    HOENN_TO_NATIONAL(CULMOTH),
    HOENN_TO_NATIONAL(BOUNDI),
    HOENN_TO_NATIONAL(BOUNDIERE),
    HOENN_TO_NATIONAL(GRUMM),
    HOENN_TO_NATIONAL(GLITAS),
    HOENN_TO_NATIONAL(GLITRON),
    HOENN_TO_NATIONAL(MISTILE),
    HOENN_TO_NATIONAL(YUREKI),
    HOENN_TO_NATIONAL(YUKIMI),
    HOENN_TO_NATIONAL(YUMIRA),
    HOENN_TO_NATIONAL(TURBIN),
    HOENN_TO_NATIONAL(TURMADE),
    HOENN_TO_NATIONAL(TURMAG),
    HOENN_TO_NATIONAL(ELECTORO),
    HOENN_TO_NATIONAL(ELECTRON),
    HOENN_TO_NATIONAL(EXCAVA),
    HOENN_TO_NATIONAL(EXCELSIA),
    HOENN_TO_NATIONAL(DUSTOS),
    HOENN_TO_NATIONAL(DUSTOR),
    HOENN_TO_NATIONAL(AERFER),
    HOENN_TO_NATIONAL(AERAXIS),
    HOENN_TO_NATIONAL(FLARION),
    HOENN_TO_NATIONAL(FLARIX),
...
{
    return sHoennSpeciesIdToCryId[species];
}
