...
static void LoadCreditsMonPic(u8 whichMon)
{
    ...
    case CREDITSMON_CHARIZARD:
        ...
        LoadMonPicInWindow(SPECIES_VESPAS, SHINY_ODDS, 0, TRUE, 10, 0);
    ...
    case CREDITSMON_VENUSAUR:
        ...
        FillWindowPixelBuffer(0, PIXEL_FILL(0));
        LoadMonPicInWindow(SPECIES_AERFER, SHINY_ODDS, 0, TRUE, 10, 0);
    ...
    case CREDITSMON_BLASTOISE:
        ...
        FillWindowPixelBuffer(0, PIXEL_FILL(0));
        LoadMonPicInWindow(SPECIES_FUMARIN, SHINY_ODDS, 0, TRUE, 10, 0);
    ...
    case CREDITSMON_PIKACHU:
        ...
        FillWindowPixelBuffer(0, PIXEL_FILL(0));
        LoadMonPicInWindow(SPECIES_SORVOL, SHINY_ODDS, 0, TRUE, 10, 0);
...
static u16 GetCreditsMonSpecies(u8 whichMon)
{
    ...
    {
    case CREDITSMON_CHARIZARD:
        return SPECIES_TERRIGRON;
    case CREDITSMON_VENUSAUR:
        return SPECIES_STELARUS;
    case CREDITSMON_BLASTOISE:
        return SPECIES_AEROPEX;
    case CREDITSMON_PIKACHU:
        return SPECIES_VINTRUB;
    default:
        return SPECIES_NONE;
    }
}
