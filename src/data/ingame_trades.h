static const struct InGameTrade sInGameTrades[] = {
    [INGAME_TRADE_MR_MIME] = 
    {
        ...
        .otGender = MALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_KLODION
    }, 
    [INGAME_TRADE_JYNX] = 
    {
        .nickname = _("ZYNX"),
        ...
        .otGender = MALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_IGNITOR
    }, 
    [INGAME_TRADE_NIDORAN] = 
    {
        ...
        .otGender = FEMALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_VERDURA
        ...
        .otGender = FEMALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_CALLIGO
#endif
    }, 
    [INGAME_TRADE_FARFETCHD] = 
    {
        ...
        .otGender = MALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_FUMINDO
    }, 
    [INGAME_TRADE_NIDORINOA] = 
    {
        ...
        .otGender = MALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_TORVIA
#elif defined(LEAFGREEN)
        .nickname = _("NINO"),
        ...
        .otGender = MALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_ASTRUX
#endif
    }, 
    [INGAME_TRADE_LICKITUNG] = 
    {
        ...
        .sheen = 10,
#if defined(FIRERED)
        .requestedSpecies = SPECIES_LEVORA
#elif defined(LEAFGREEN)
        .requestedSpecies = SPECIES_LURIOS
#endif
    }, 
    [INGAME_TRADE_ELECTRODE] = 
    {
        ...
        .otGender = MALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_FLENURA
    }, 
    [INGAME_TRADE_TANGELA] = 
    {
        ...
        .otGender = FEMALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_CELESTUS
    },
    [INGAME_TRADE_SEEL] = 
    {
        .nickname = _("SEELOR"),
        ...
        .otGender = MALE,
        .sheen = 10,
        .requestedSpecies = SPECIES_VINTRUB
    }
};
