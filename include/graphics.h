...
extern const u32 gMonFrontPic_Scorch[];
extern const u32 gMonPalette_Scorch[];
extern const u32 gMonBackPic_Scorch[];
extern const u32 gMonShinyPalette_Scorch[];
extern const u32 gMonStillFrontPic_Scorch[];
extern const u8 gMonIcon_Scorch[];
extern const u8 gMonFootprint_Scorch[];
extern const u32 gMonFrontPic_Scorion[];
extern const u32 gMonPalette_Scorion[];
extern const u32 gMonBackPic_Scorion[];
extern const u32 gMonShinyPalette_Scorion[];
extern const u32 gMonStillFrontPic_Scorion[];
extern const u8 gMonIcon_Scorion[];
extern const u8 gMonFootprint_Scorion[];
extern const u32 gMonFrontPic_Scroba[];
extern const u32 gMonPalette_Scroba[];
extern const u32 gMonBackPic_Scroba[];
extern const u32 gMonShinyPalette_Scroba[];
extern const u32 gMonStillFrontPic_Scroba[];
extern const u8 gMonIcon_Scroba[];
extern const u8 gMonFootprint_Scroba[];
