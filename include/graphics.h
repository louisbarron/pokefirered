...
extern const u8 gMonFootprint_Test[];
extern const u32 gMonFrontPic_Testtwo[];
extern const u32 gMonPalette_Testtwo[];
extern const u32 gMonBackPic_Testtwo[];
extern const u32 gMonShinyPalette_Testtwo[];
extern const u32 gMonStillFrontPic_Testtwo[];
extern const u8 gMonIcon_Testtwo[];
extern const u8 gMonFootprint_Testtwo[];
...
// pokemon_icons
extern const u8 gMonIcon_Test[];extern const u8 gMonIcon_Testtwo[];
extern const u8 gMonIcon_Egg[];
extern const u8 gMonIcon_QuestionMark[];
